...
import Controlador.ControllerSettings;
...
public class PanelSettings extends javax.swing.JPanel {
      ...
      public PanelSettings() {
            ...
            ControllerSettings.chargeLanguages(re.getLanguageSelected());
            ...
            ControllerSettings.showLanguageSelected(comboLanguages, re.getLanguageSelected());
            ControllerSettings.showThemeSelected(comboThemes, re.getTheme());
      }
      ...
      private void comboLanguagesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboLanguagesActionPerformed
            int selectedLanguage = comboLanguages.getSelectedIndex();
            boolean select = ControllerSettings.changeLanguage(selectedLanguage);
            ControllerSettings.chargeLanguages(select);
            ControllerSettings.changeLanguageCombox(comboThemes, comboLanguages);
