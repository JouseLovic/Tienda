...
public class EntriesRepo {
    ...
    public ArrayList<Vendor> buscaProveedores(){
      db = new DB();
      Connection conexion = db.dameConexion();
      ArrayList<Vendor> listaComparacion = new ArrayList<>();
      ...
      try {
          ...
          while(rs.next()){
            ...
            String articulos = rs.getString(7);
              ...
              Vendor proveedor = new Vendor(idProveedor, nombre, fechaNacimiento, cedula, email, empresa, articulos);
         ...
         e.printStackTrace();
         JOptionPane.showMessageDialog(null, "Ha ocurrido un error en la clase 'EntriesRepo' debido a: "+e.getCause());
    ...
    public void insertarEntradaP(EntriesProducts entrada){
        db = new DB();      
        ...
        public void insertarProductoExistente(EntriesProducts entrada){
          db = new DB();      
          Connection conecta = db.dameConexion();
          String estadoE = "Entrada";
          CallableStatement entryP = null;
            ...
            factura = conecta.prepareCall("{call creaFactura(?,?,?,?,?)}");
                ...
                entryP.setString(1, idFactura);
                 ...
                 factura.executeQuery();
                  ...
                  JOptionPane.showMessageDialog(null, "Problema encontrado en 'EntriesRepo' debido a: "+ex.getMessage());
                  try {
                    conecta.rollback();//regresamos el estado anterior de los datos en caso de error    
                  } catch (SQLException e) {
                    e.printStackTrace();
    ...
    public void eliminar(String codigoFactura){
     ...
     public ArrayList<EntriesProducts> mostrar(String idF){
        db = new DB();
        Connection conecta = db.dameConexion();
        ArrayList<EntriesProducts> listaEspecifica = new ArrayList<>();
        Statement ps;
        ResultSet rs = null;
          ...
          try{
              ...
              while(rs.next()){
                ...
                EntriesProducts entradas = new EntriesProducts(idFactura, codigoP, desc, fecha, precio, cantidad, seccion, marca, idProveedor);
