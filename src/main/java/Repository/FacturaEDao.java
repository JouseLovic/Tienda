...
public class FacturaEDao {
    ...
    public void insertarFactura(EntriesBill facturaE){
         db = new DB();     
        ...
        public void actualizarFactura(EntriesBill facturaE, String idP){
              db = new DB();
            Connection conecta = db.dameConexion();
    ...
    public void eliminarFactura(String id){
       ...
       CallableStatement factura = null;
        ...
        public ArrayList<EntriesBill> mostrarFacturas(String nombre){
            db = new DB();
            Connection conecta = db.dameConexion();
            ArrayList<EntriesBill> listaEspecifica = new ArrayList<>();
            Statement ps = null;
            ResultSet rs = null;
                ...
                ps = conecta.createStatement();
                  ...
                  if(!nombre.equals("")){  rs = ps.executeQuery("Select * from factura_entrada where id_de_factura like'%"+nombre+"%'");}
                    ...
                    while(rs.next()){
                      ...
                      EntriesBill factura_E = new EntriesBill(idFactura, fecha, precio, cantidad, descripcion, idProveedor);
